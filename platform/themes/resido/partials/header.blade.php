    ...
    <div class="topbar bg-brand p-2 d-none d-sm-block">
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a class="text-white" "> <i class="fas fa-home">&nbsp</i>      Address: Burj Al Sadiq, Abu Bakar Avenue, Safari Valley, Opposite Bahria Town Head Office , Bahria Town Phase 8, Rawalpindi </a>
                    </div>
                ...
                @if (is_plugin_active('real-estate'))
                    <div class="topbar-right d-flex align-items-center">
                        <div class="topbar-wishlist">
                            <a class="text-white" ">&nbsp&nbsp<i class="fas fa-envelope">&nbsp</i>heavensland.pak@gmail.com&nbsp&nbsp&nbsp&nbsp<i class="fas fa-phone">&nbsp</i> +9251-8350115 &nbsp&nbsp&nbsp&nbsp<i class="fas fa-mobile">&nbsp</i>+92333-3335902&nbsp&nbsp&nbsp&nbsp<i class="fas fa-mobile"></i>&nbsp +92333-5655550</a>
                        </div>
                ...
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    @if (is_plugin_active('real-estate'))
                        <ul class="nav-menu nav-menu-social align-to-right">
                            <li>
                                <a href="{{ route('public.account.properties.create') }}" class="text-success"><img src="{{ Theme::asset()->url('') }}/img/submit.svg" width="20" alt="" class="mr-2" /> {{ __('Evaluate Property') }}</a>
                            </li>
